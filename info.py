...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "6462373515 7313000783").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Ayush"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "B2A_ICONIC")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002837760994").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002641605774"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002789701775"))
...
request_channel = environ.get("REQUEST_CHANNEL", "-1002698732575")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002429208792"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "-1002587937184")
